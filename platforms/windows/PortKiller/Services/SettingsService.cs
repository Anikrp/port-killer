...
public class SettingsService
{
    ...
    private class SettingsData
    {
        ...
        /// <summary>When true, closing the window hides to tray. When false, closing exits the app.</summary>
        public bool CloseToTray { get; set; } = true;
        /// <summary>When true, start with main window hidden (tray only).</summary>
    ...
    public void SaveCloseToTray(bool value)
    {
        var data = LoadSettingsData();
    ...
    {
        var data = LoadSettingsData();
        return data.StartMinimizedToTray;
    }

    public void SaveStartMinimizedToTray(bool value)
    {
        var data = LoadSettingsData();
        data.StartMinimizedToTray = value;
        SaveSettingsData(data);
    }
